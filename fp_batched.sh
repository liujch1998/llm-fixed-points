...
# uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-4b-it --batch_size 1 --seed $seed -n gemma3-4b-it_seed$seed
# uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-4b-pt --batch_size 1 --seed $seed -n gemma3-4b-pt_seed$seed
# uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-12b-it --batch_size 1 --seed $seed -n gemma3-12b-it_seed$seed
# uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-12b-pt --batch_size 1 --seed $seed -n gemma3-12b-pt_seed$seed
