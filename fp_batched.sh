...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name Qwen/Qwen3-0.6B --batch_size 1 --seed $seed -n qwen3-0.6b-inst_seed$seed
...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name Qwen/Qwen3-1.7B --batch_size 1 --seed $seed -n qwen3-1.7b-inst_seed$seed
...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name Qwen/Qwen3-4B --batch_size 1 --seed $seed -n qwen3-4b-inst_seed$seed
...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name Qwen/Qwen3-8B --batch_size 1 --seed $seed -n qwen3-8b-inst_seed$seed
...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name Qwen/Qwen3-14B --batch_size 1 --seed $seed -n qwen3-14b-inst_seed$seed
...
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-270m-it --batch_size 1 --seed $seed -n gemma3-270m-inst_seed$seed
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-270m --batch_size 1 --seed $seed -n gemma3-270m-base_seed$seed
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-1b-it --batch_size 1 --seed $seed -n gemma3-1b-inst_seed$seed
uv run fp_batched.py --dtype fp32 --scheduler_patience 1000 --detach --eval_every 1000 --eval_len 100 --model_name google/gemma-3-1b-pt --batch_size 1 --seed $seed -n gemma3-1b-base_seed$seed
